...
void keyt()
{
    ...
    if(K3==0&&ax3==0) {ss++;ax3=1;}
    if(K3>0) ax3=0;
    if(K4==0&&ax4==0) {ss--;ax4=1;}
    if(K4>0) ax4=0;
    if(ss<=30)  ss=30;
    if(ss>=60)  ss=60;
}
